...
//
// Usage:
//   tsx tests/manual/tools/diff-metrics.ts \
//     tests/manual/outputs/mt-11-ts.metrics.json \
//     tests/manual/outputs/mt-11-wasm.metrics.json
...
if (!fileA || !fileB) {
  console.error(
    'Usage: tsx tests/manual/tools/diff-metrics.ts <a.metrics.json> <b.metrics.json>',
  );
  process.exit(1);
}
