...
//
// Usage:
//   tsx tests/manual/tools/verify-metrics.ts tests/manual/outputs/mt-14-baseline-grid.metrics.json
//   tsx tests/manual/tools/verify-metrics.ts tests/manual/outputs/*.metrics.json
...
if (args.length === 0) {
  console.error(
    'Usage: tsx tests/manual/tools/verify-metrics.ts <file.metrics.json> [...]',
  );
  process.exit(1);
}
