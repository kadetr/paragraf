 ...
 * @returns {string}
 */
function compute_breakpoints_wasm(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
 ...
 * @returns {string}
 */
function font_metrics_wasm(font_json) {
    let deferred2_0;
    let deferred2_1;
    try {
...
exports.font_metrics_wasm = font_metrics_wasm;
 ...
 * @returns {string}
 */
function get_glyph_path(font_id, glyph_id, x, y, font_size) {
    let deferred2_0;
    let deferred2_1;
    try {
...
exports.get_glyph_path = get_glyph_path;
 ...
 * @returns {string}
 */
function measure_text_wasm(text, font_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.measure_text_wasm = measure_text_wasm;
 ...
 * @param {Uint8Array} data
 */
function register_font(font_id, data) {
    const ptr0 = passStringToWasm0(font_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
function round_trip_node(node_json) {
    let deferred2_0;
    let deferred2_1;
    try {
...
exports.round_trip_node = round_trip_node;
 ...
 * @returns {string}
 */
function round_trip_paragraph(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.round_trip_paragraph = round_trip_paragraph;
 ...
 * @returns {string}
 */
function shape_text_wasm(text, font_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {string}
 */
function space_metrics_wasm(font_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(font_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.space_metrics_wasm = space_metrics_wasm;
 ...
 * @returns {string}
 */
function traceback_wasm(input_json) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
...
exports.traceback_wasm = traceback_wasm;
 ...
 * @returns {string}
 */
function traceback_wasm_binary(f64s, u8s, line_widths_f64, line_width, tolerance, emergency_stretch, looseness, widow_penalty, orphan_penalty, consecutive_hyphen_limit) {
    let deferred4_0;
    let deferred4_1;
    try {
...
exports.traceback_wasm_binary = traceback_wasm_binary;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./knuth_plass_wasm_bg.js": import0,
    };
}
...
const wasmPath = `${__dirname}/knuth_plass_wasm_bg.wasm`;
