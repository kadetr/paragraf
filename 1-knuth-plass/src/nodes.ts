...
// Approximation: for words ending with a superscript/subscript span the glue width
// is measured against a smaller font, slightly underestimating natural spacing.
// Future improvement: use the dominant (base) font or a weighted average.
